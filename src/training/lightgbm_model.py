...
# Config specifica
python src/training/lightgbm_model.py --use-tuned-params --tuning-config random_iter50_cv5_2026-01-24_20.02.json
...
def main():
    ...
    if args.use_tuned_params:
        ...
        if not tuned_params:
            print("\n  Parametri tuned non trovati, uso random search")
